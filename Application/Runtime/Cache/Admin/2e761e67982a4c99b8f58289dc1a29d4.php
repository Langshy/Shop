...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/YFShop/Public/Admin/css/plugins/webuploader/webuploader.css">
    <link rel="stylesheet" type="text/css" href="/YFShop/Public/Admin/css/demo/webuploader-demo.min.css">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                   <a class="list-group-item">
                    ...
                    <a class="list-group-item">
                        <p>商品图片</p>
                        <img src="<?php echo ($product["photoaddress"]); ?>" width="100%">
                    </a>
                    <a class="list-group-item">
                        <p>商品价格</p>
...
<script src="/YFShop/Public/Admin/js/jquery.min.js?v=2.1.4"></script>
...
<script charset="utf-8" src="/YFShop/Public/Admin/kindeditor/kindeditor-all.js"></script>
<script charset="utf-8" src="/YFShop/Public/Admin/kindeditor/lang/zh-CN.js"></script>
<script>
