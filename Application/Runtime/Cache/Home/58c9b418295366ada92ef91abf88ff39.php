...
<body>
<header>
    <div class="header_T"><img src="/Public/Home/images/形状 7 拷贝.png" width="100%"/></div>
    <img src="/Public/Home/images/bench-accounting-49909.png" width="100%" height="100%"/>
    ...
    <button class="header_button">立即购买</button>
</header>
<div class="main">
    <div class="main_name">
        <ul>
            <li><a href="<?php echo U('Home/Shop/index');?>" class="this">全部</a></li>
            <?php if(is_array($type)): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($i % 2 );++$i;?><li class="main_name_type"><a href="<?php echo U('Home/Shop/part');?>?id=<?php echo ($t["tid"]); ?>"><input type="hidden" value="<?php echo ($t["tid"]); ?>"><?php echo ($t["tname"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
    </div>
    <div class="main_shop">
        <ul>
            <?php if(is_array($product)): $i = 0; $__LIST__ = $product;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a): $mod = ($i % 2 );++$i;?><li>
                ...
                <div><img src="<?php echo ($a["photoaddress"]); ?>"  width="80%"/></div>
    ...
    <div class="main_paging">
        <div class="number"><button>1</button><button>2</button><button>3</button><span>...共10页,</span>跳转到<input type="number" min="1" value="1"  style="width: 50px">页<button>确定</button></div>
        <div class="paging"><button>上一页</button><button>下一页</button></div>
    </div>
</div>
<footer>
...
<div class="mask_top">
    <a href="#"><img src="/Public/Home/images/形状 820.png" width="50" height="50" title="返回顶部"></a>
</div>
</body>
</html>
<script>
    ...
    $(function () {
        ...
        $(".main_name_type a").on('click',(function () {
            if($($this)[0].href==String(window.location)){
                $(this).css("color","#138b8b").css("border-left","1px solid")
            }
